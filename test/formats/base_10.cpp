...
TEST_AMOUNT(max_money_retarget, max_money(), "83999999.9076", btc_decimal_places)
TEST_AMOUNT(overflow_max_money_retarget, max_money() + 1, "83999999.90760001", btc_decimal_places)
...
// Max money (mainnet, testnet):
TEST_FORMAT(max_money_retarget, "83999999.9076", max_money(), btc_decimal_places)
TEST_FORMAT(overflow_max_money_retarget, "83999999.90760001", max_money() + 1, btc_decimal_places)
